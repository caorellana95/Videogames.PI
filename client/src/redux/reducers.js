import { GET_VIDEOGAMES, GET_GENRES, GET_DETAILS, SEARCH_BY_NAME, CREATE_VIDEOGAME, FILTER_BY_CREATION,FILTER_BY_GENRE, SORT_BY_RATING, SORT_BY_AZ, CLEAR_DETAIL } from '../redux/actions'
